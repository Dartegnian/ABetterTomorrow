...
var messages = [
    ...
    "Like, that's so kind of you all.",
    ...
    "I wish I can go back in time and sincerely thank you all for the support.",
    ...
    "Vincent Huliganga",
    "and Nathan Melad",
    "Sorry mates if I'm almost always the bottom fragger.",
    ...
    "There isn't a day that goes by where I wouldn't wish",
    "That I was back in APC, sitting through another boring lesson, with you all by my side.",
    "Fuck life, but I guess things happen for a reason.",
    "I hope you're all doing just fine there (I'm sure).",
    "Even without your annoying class clown, who always tries to make a joke, \"banat,\" or something.",
    "Sorry if I'm almost always hyperactive and seeming like a complete prankster.",
    ...
    "(Ew, cheezy stuff.)",
    "But seriously",
    "I'm glad to have people in my life that makes saying goodbye hard.",
    ":)",
    "..*sniffs*..",
    "Ahem, who else...",
    "My bros, Loy and JR.",
