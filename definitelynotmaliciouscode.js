...
var messages = [
    ...
    "If that's the case, feel free to look around!",
    ...
    "The first on the list is my EGRAMCM professor, Miss Mina.",
    "(She's been a really, really kind and supportive professor.)",
    "(Plus she's SUPER cute lmao.)",
    "(Is she of Korean descent?)",
    "(Or is she of Japanese descent?)",
    "(Or is she a pure Filipina?)",
    "(Either way, she's super cute lol.)",
    "#professorgoals",
    ...
    "It's a Korean girl group and I shouldn't be liking them, I know.",
    ...
    "Who else to thank?",
    "Definitely my Big Sister Elaine. (Yes, I know I shouldn't capitalize \"big sister\")",
