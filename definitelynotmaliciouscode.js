...
<<<<<<< HEAD
	...
	"Have you listened to Girls' Generation's new album yet?",
	"I URGE you to listen to it. It's so good, seriously.",
	"If you're looking to try it out to know how the rest of the album sounds,",
	"then I suggest starting with one \"One Last Time.\"",
	"Go on YouTube right now and search for \"one last time snsd english lyrics\"",
	"and listen to it, plus the translations are synced up so you know what they're saying.",
	"It's such a great song, seriously. Oh my God.",
	"The first I listened to the song along with the translation, it made my hairs stand on end.",
	"\"One Last Time\" is basically a song about",
	"knowing that your relationship will come to an end soon.",
	"The song doesn't state the goodbye of a romantic relationship.",
	"Just any relationship wherein you loved the other person.",
	"You know,",
	"if I could sing this to Elaine (in English)",
	"I would do it because I miss her so much.",
	"Some of the lines in the song can really strike a chord with me.",
	"\"If you wanted to change, I wanted to stay the same.\"",
	"\"Over time, the two steps that were side by side",
	"are out of step.\"",
...
=======
	...
	"UPDATE: I HAVE THE SHIRT WITH ME NOW! WOOT~",
	"It's pink, though; I hate pink.",
	"If it came in black or white, it'd be my usual casual wear.",
	"Still, I want to look good and having a matching set of attire when I wear it.",
	"So I bought this pink watch that toally complemented the shirt",
	"and it looks fab asf.",
	"I'm still waiting for my pink baseball cap to arrive, though.",
	"I'll receive it in a few weeks or so",
	"but hopefully soon, 'cause I want to wear my pink shirt and watch.",
	"I just wanted to buy the cap because I want to hide my face lol.",
	"I'm afraid to go around in public wearing a pink shirt that just screams\"I LOVE GIRLS' GENERATION!\"",
	"But eh, oh well, now that I think about it, I shouldn't really care.",
...
>>>>>>> origin/master
	...
	"We just.. grew apart.",
	"I explained my feelings of missing her in my \"Missing Things\" post, as well in my other posts.",
	...
	"And I look at the world in a better light. The world might seem doomed, but I have hope.",
